      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav ml-auto">
         <li class="nav-item">
          ...
          <li class="nav-item">
           <a class="nav-link active" href="../customersell.html"> Swap Product> Exchange</a>
         </li>
         <li class="nav-item">
    ...
    if ($result = $conn->query($query)) {
      ...
      $index = 1;
        ...
        while ($row = $result->fetch_assoc()) {
            printf ('<tr> <td>%s</td> <td>%s</td> <td>%s</td> <td>%s</td> <td><a href="../payment.php?price=%s"> BUY</a> </td> 
              </tr>', $index, $row["HDD_NAME"], $row["HDD_PRICE"], $row["HDD_STORAGE"], $row["HDD_PRICE"]);
